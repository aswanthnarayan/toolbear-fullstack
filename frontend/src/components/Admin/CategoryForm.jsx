...
const CategoryForm = ({ initialData, onSubmit, isLoading, mode }) => {
  ...
  useEffect(() => {
    if (mode === 'edit' && initialData) {
      ...
      setImagePreview(initialData.image); // Changed from imageUrl to image
    }
    ...
    <div className="min-h-[calc(100vh-100px)] h-auto py-6">
      <Card className="w-full p-6">
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)}>
          ...
          >
            {(isCreating || isUpdating) ? "Processing..." : (mode === 'add' ? "Create Category" : "Update Category")}
          </Button>
        </form>
      </Card>
